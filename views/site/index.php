...
<style>
    ...
    .dashboard-wrap {
        ...
        overflow: hidden;
        margin-top: 54px;
        /* navbar fijo ~62px - body padding-top 8px */
    }
    ...
    .fc .fc-button:hover {
        ...
        color: var(--accent-dark, #1d4ed8) !important;
    }
    ...
    #cal-area.cheka-on #calendar-container {
        display: none;
    }

    #cal-area.cheka-on #cheka-view {
        display: flex;
        flex: 1;
        min-height: 0;
    }
    ...
    .cheka-grid {
        ...
        align-content: start;
        width: 100%;
        /* evita que las filas se estiren y bajen el contenido */
    }
    ...
    .cheka-ticket-block:hover {
        ...
        z-index: 10;
        overflow: visible;
        /* muestra cliente al hacer hover */
    }
    ...
    .cheka-blk-client {
        ...
        text-overflow: ellipsis;
        min-width: 0;
        /* permite que se recorte en estado normal */
    }
    ...
    #cheka-cal-toggle:hover {
        background: var(--accent-light, #eff6ff);
        color: var(--accent-dark, #1d4ed8);
    }

    #cheka-cal-toggle.active {
