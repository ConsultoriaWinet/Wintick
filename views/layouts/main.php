...
$this->registerLinkTag(['rel' => 'icon', 'type' => 'image/x-icon', 'href' => Yii::getAlias('@web/Logo_connombre.png')]);
...
<body class="d-flex flex-column h-100">
  ...
  <header id="mainHeader">
    <?php if (
      ...
      NavBar::begin([
        'brandLabel' => Html::img(
          Yii::getAlias('@web/Logo_connombre.png'),
          [
            'alt' => 'Wintick',
            ...
            <div class="user-dropdown-menu" id="userDropdownMenu">
              ...
              <div class="user-dropdown-header" style="display:flex; align-items:center; gap:14px;">
                <div style="position:relative; cursor:pointer;"
                  onclick="document.getElementById('avatarFileInput').click();" title="Cambiar foto">
                  <?php if ($avatarUrl): ?>
              ...
              <!-- Indicador de carga -->
              <div id="avatarUploadStatus"
                style="display:none; padding:8px 16px; font-size:12px; color:#6b7280; background:#f9fafb; border-bottom:1px solid #e5e7eb;">
                <i class="fas fa-spinner fa-spin"></i> Subiendo foto...
              </div>

              <!-- Opción: cambiar foto -->
              <div class="user-dropdown-item" onclick="document.getElementById('avatarFileInput').click();"
              ...
              <?php if ($currentRol === 'Consultores'): ?>
                <div class="user-dropdown-item" onclick="toggleColorPicker(event)"
                  style="flex-direction:column; align-items:flex-start; gap:8px;">
                  <div style="display:flex; align-items:center; gap:12px; width:100%;">
                    <span
                      style="width:16px; height:16px; border-radius:50%; background:<?= Html::encode($currentColor) ?>; border:2px solid #e5e7eb; flex-shrink:0;"
                      id="colorPreviewIcon"></span>
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:8px; margin-bottom:8px;">
                      ...
                      foreach ($coloresRapidos as $c): ?>
                        <span onclick="seleccionarColor(event, '<?= $c ?>')"
                          ...
                          onmouseover="this.style.border='2px solid #1f2937'"
...
JS;
  ...
  <script>
    ...
    const NOTIF_ICON = <?= json_encode(Yii::getAlias('@web/Logo_connombre.png')) ?>;
