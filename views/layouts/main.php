...
$this->registerLinkTag(['rel' => 'icon', 'type' => 'image/x-icon', 'href' => Yii::getAlias('@web/Logo_sinnombre.png')]);
...
<body class="d-flex flex-column h-100">
    ...
    <header id="mainHeader">
        <?php if (
            ...
            NavBar::begin([
                'brandLabel' => Html::img(
                    Yii::getAlias('@web/Logo_sinnombre.png'),
                    [
                        'alt' => 'Wintick',
...
JS;
    ...
    <script>
        ...
        const NOTIF_ICON = <?= json_encode(Yii::getAlias('@web/Logo_sinnombre.png')) ?>;
