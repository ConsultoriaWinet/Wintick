...
.multi-row .btn-remove:hover { background: #fef2f2; }
.btn-add-row {
    display: inline-flex;
    align-items: center;
    gap: 5px;
...
.btn-add-row:hover { background: var(--accent-light,#eff6ff); }
.multi-header {
    display: flex;
    gap: 8px;
    margin-bottom: 4px;
...
.multi-header .lbl-col { width: 32%; flex-shrink: 0; }
.multi-header .val-col { flex: 1; }
</style>
...
<template id="tel-tpl">
    <div class="multi-row">
        <input type="text" class="cli-form-input row-label" style="<?= $inputStyle ?>width:32%;" placeholder="Ej: Oficina, CP. Norma">
        <input type="text" class="cli-form-input row-valor" style="<?= $inputStyle ?>flex:1;" placeholder="Número de teléfono">
        <button type="button" class="btn-remove" onclick="multiRemoveRow(this)">×</button>
    </div>
</template>
<template id="wa-tpl">
    <div class="multi-row">
        <input type="text" class="cli-form-input row-label" style="<?= $inputStyle ?>width:32%;" placeholder="Ej: Sonia, Gerente">
        <input type="text" class="cli-form-input row-valor" style="<?= $inputStyle ?>flex:1;" placeholder="Número WhatsApp">
        <button type="button" class="btn-remove" onclick="multiRemoveRow(this)">×</button>
    </div>
</template>
<template id="correo-tpl">
    <div class="multi-row">
        <input type="text" class="cli-form-input row-label" style="<?= $inputStyle ?>width:32%;" placeholder="Ej: Facturación, Principal">
        <input type="text" class="cli-form-input row-valor" style="<?= $inputStyle ?>flex:1;" placeholder="correo@empresa.com">
        <button type="button" class="btn-remove" onclick="multiRemoveRow(this)">×</button>
    </div>
</template>
